...
## About Me
Bilingual Data Analyst (FR/EN) with a strong background in mathematics and hands-on experience in Python, SQL, BI, and data automation. I focus on building reliable data pipelines and end-to-end data products, combining Data Engineering, Machine Learning, and business-driven decision making.
...
### 1. [Zero-Defect Credit Risk Pipeline](https://github.com/alouiyaz78/Zero-defect-credit-risk-pipeline)
...
### 2. [Hadoop Mini Cluster + MapReduce KPI Dashboard](https://github.com/alouiyaz78/Hadoop_mini_cluster)
...
### 3. [NYC Taxi Data ETL Pipeline – Databricks & Delta Lake](https://github.com/alouiyaz78/Databricks_project_nyct)
...
### 4. [London Hotel Chatbot](https://github.com/alouiyaz78/Chatbot)
...
### 5. [Ontario 511 API – Traffic Data Automation](https://github.com/alouiyaz78/Project_Ontario_511)
Python | SQL Server | API Automation  

Automated data ingestion pipeline with scheduled extraction and KPI reporting.
...
### Credit Risk Project
![Dashboard](img/Dashboard_1_project_credit_score.png)
![Dashboard](img/Dashboard_2_project_credit_score.png)
![Dashboard](img/Dashboard_3_project_credit_score.png)
![Dashboard](img/Dashboard_4_project_credit_score.png)
